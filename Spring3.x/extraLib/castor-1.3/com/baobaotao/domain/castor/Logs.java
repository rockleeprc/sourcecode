...
public class Logs implements java.io.Serializable {
     ...
     * Field _loginLogList.
     */
    private java.util.List<com.baobaotao.domain.castor.LoginLog> _loginLogList;
    ...
    public Logs() {
        super();
        this._loginLogList = new java.util.ArrayList<com.baobaotao.domain.castor.LoginLog>();
    }
    ...
    public void addLoginLog(
            final com.baobaotao.domain.castor.LoginLog vLoginLog)
     ...
     * collection
     */
    public java.util.Enumeration<? extends com.baobaotao.domain.castor.LoginLog> enumerateLoginLog(
    ) {
     ...
     */
    public com.baobaotao.domain.castor.LoginLog getLoginLog(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (com.baobaotao.domain.castor.LoginLog) _loginLogList.get(index);
    }
    ...
    public com.baobaotao.domain.castor.LoginLog[] getLoginLog(
        ...
        com.baobaotao.domain.castor.LoginLog[] array = new com.baobaotao.domain.castor.LoginLog[0];
        return (com.baobaotao.domain.castor.LoginLog[]) this._loginLogList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends com.baobaotao.domain.castor.LoginLog> iterateLoginLog(
    ) {
     ...
     */
    public com.baobaotao.domain.castor.LoginLog removeLoginLogAt(
            final int index) {
        java.lang.Object obj = this._loginLogList.remove(index);
        return (com.baobaotao.domain.castor.LoginLog) obj;
    }
     ...
     */
    public void setLoginLog(
            final com.baobaotao.domain.castor.LoginLog[] vLoginLogArray) {
        //-- copy array
        _loginLogList.clear();
     ...
     */
    public static com.baobaotao.domain.castor.Logs unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.baobaotao.domain.castor.Logs) org.exolab.castor.xml.Unmarshaller.unmarshal(com.baobaotao.domain.castor.Logs.class, reader);
    }
